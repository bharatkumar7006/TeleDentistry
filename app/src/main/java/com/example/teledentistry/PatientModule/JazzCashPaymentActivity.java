...
public class JazzCashPaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC21749";
    private final String Jazz_Password        = "30s1c182u6";
    private final String Jazz_IntegritySalt   = "yx7x21795u";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fee = intentData.getStringExtra("fee");
        System.out.println("AhmadLogs: price_before : " +fee);

        String[] values = fee.split("\\.");
        fee = values[0];
        fee = fee + "00";
        System.out.println("AhmadLogs: fee : " +fee);
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(JazzCashPaymentActivity.this, AppointmentJazzPayFinishSpecialistActivity.class);
