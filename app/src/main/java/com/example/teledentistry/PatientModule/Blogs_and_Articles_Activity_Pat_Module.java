...
public class Blogs_and_Articles_Activity_Pat_Module extends AppCompatActivity implements ViewTreeObserver.OnScrollChangedListener{
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blogs_and__articles_pat_module);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String url, final String userAgent, final String contentDisposition, final String mimetype, long contentLength) {
                Dexter.withActivity(Blogs_and_Articles_Activity_Pat_Module.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                                ...
                                Toast.makeText(Blogs_and_Articles_Activity_Pat_Module.this, "Downloading File...", Toast.LENGTH_SHORT).show();
