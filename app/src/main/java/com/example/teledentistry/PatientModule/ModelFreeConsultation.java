...
public class ModelFreeConsultation {
    String docname, exper, status, fee, slot, soec, sname;
    int iv,fb,consult,appointment,mon,tue,wed,thurs,fri,sat,sun;

    public ModelFreeConsultation(String docname, String exper, String status, String fee, String slot, String soec, String sname, int iv, int fb, int consult, int appointment, int mon, int tue, int wed, int thurs, int fri, int sat, int sun) {
